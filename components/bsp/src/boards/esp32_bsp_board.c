...
esp_err_t bsp_btn_register_callback(bsp_button_t btn, button_event_t event,
                                    button_cb_t callback, void *user_data) {
...
esp_err_t bsp_codec_dev_resume(void) {
  return bsp_codec_set_fs(CODEC_DEFAULT_SAMPLE_RATE, CODEC_DEFAULT_BIT_WIDTH,
...
const boards_info_t *bsp_board_get_info(void) { return &g_boards_info; }
...
esp_err_t bsp_board_init(void) {
  ...
  ESP_ERROR_CHECK(bsp_btn_register_callback(BSP_BUTTON_MUTE, BUTTON_PRESS_DOWN,
                                            mute_btn_handler,
                                            (void *)BUTTON_PRESS_DOWN));
  ESP_ERROR_CHECK(bsp_btn_register_callback(BSP_BUTTON_MUTE, BUTTON_PRESS_UP,
                                            mute_btn_handler,
