 ...
 *
 * For ESP32-S3-BOX-3 in this repo, we drive a single GPIO LED (GPIO40) using the
 * simple `app_led_*` API from app_led.c.
 */
...
{
    return light_ctrl_set(!light_ctrl_get());
}
